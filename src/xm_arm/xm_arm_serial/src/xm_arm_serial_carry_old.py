        ...
        while not rospy.is_shutdown():
            ...
            for num in gripper_pos_serial:
                gripper_pos_check[0] = chr(
                    (ord(gripper_pos_check[0]) + ord(num)) % 256)
