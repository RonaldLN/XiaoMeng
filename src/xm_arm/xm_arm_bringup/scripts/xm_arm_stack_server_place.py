...
class ArmStack:
    ...
    def __init__(self):
        ...
        self.arm_stack_server = actionlib.SimpleActionServer(
            '/xm_arm/arm_stack_place', xm_ArmStackAction, self.action_cb, False)
        self.arm_stack_server.start()
        rospy.loginfo("\033[1;32mArm Stack  place Start!\033[0m")
    ...
    def action_cb(self, goal):
        ...
        target_camera_pose.pose.position.x = target_camera_point.point.x+0.1
