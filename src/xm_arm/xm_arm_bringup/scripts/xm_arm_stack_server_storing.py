...
class ArmStack:
    ...
    def __init__(self):
        ...
        #************arm stack**********************#
        rospy.loginfo("start the arm_storing...")
        self.arm_stack_server = actionlib.SimpleActionServer(
            '/xm_arm/arm_storing', xm_ArmStackAction, self.action_cb, False)
        self.arm_stack_server.start()
        rospy.loginfo("\033[1;32mArm Storing Start!\033[0m")
    ...
    def action_cb(self, goal):
        ...
        if self.arm_solution_mode == 1:
            ...
            target_arm_joint_0_point_ready.point.x = target_arm_joint_0_point.point.x-0.1
            ...
            if arm_solution_ready_is_succeed == True:
                ...
                if arm_solution_is_succeed == True:
                    ...
                    self.plat_client.wait_for_result(rospy.Duration(60.0))
                    rospy.loginfo("...plat move")

                    open_goal = get_gripper_or_plat_goal_from_position(
                        gripper_open)
