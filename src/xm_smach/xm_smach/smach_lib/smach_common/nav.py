...
class NavStack(State):
    ...
    def nav_thing(self, pos_xm):
        ...
        nav_counter = 0
        # while nav_counter < 1000:
        while self.nav_client.get_state() != GoalStatus.SUCCEEDED and nav_counter < 230:
        # while self.nav_client.get_goal_status_text() != 'Goal reached.':
            nav_counter += 1
            print("I am going")
            # print(self.nav_client.get_state())
            # print(self.nav_client.get_goal_status_text())
            
            if nav_counter == 0 or nav_counter ==1 or nav_counter == 2:
                self.nav_client.send_goal(goal)
                rospy.sleep(0.5)
            else:
                pass
    ...
    def execute(self, userdata):
        ...
        try:
            ...
            if 0.2 < angle < 1.0:
                ...
                self.twist_xm.angular.z = angle / angle_rate
                # if person_x < 0.6:
