...
class Gpsr():
    def __init__(self):
        ...
        with self.xm_HandMeTHat:
            ...
            self.xm_HandMeTHat.userdata.task_num = 0
            self.xm_HandMeTHat.userdata.answer = "this is the answer"
            self.xm_HandMeTHat.userdata.current_task = -1
            self.xm_HandMeTHat.userdata.current_turn = 1
            self.xm_HandMeTHat.userdata.turn = 5              #the max_num of the mission
            self.xm_HandMeTHat.userdata.pos_xm_door = gpsr_target['livingroom']['pos']
            self.xm_HandMeTHat.userdata.waypoint = gpsr_target['dining_room_exit']['pos']
            self.xm_HandMeTHat.userdata.sentences = 'give me the mission please' #for the Speak() state
            ...
            self.xm_HandMeTHat.userdata.character = ''
            self.xm_HandMeTHat.userdata.gesture = ''
            self.xm_HandMeTHat.userdata.count_num = 0
            self.xm_HandMeTHat.userdata.objectName = ''
            self.xm_HandMeTHat.userdata.objectType = ''
            self.xm_HandMeTHat.userdata.targetName = ''
            self.xm_HandMeTHat.userdata.targetType = ''
            self.xm_HandMeTHat.userdata.check_first = 0
            self.xm_HandMeTHat.userdata.check_second = 0
        ...
        intro_server = IntrospectionServer('xm_gpsr',self.xm_HandMeTHat,'/XM_ROOT')
        intro_server.start()
