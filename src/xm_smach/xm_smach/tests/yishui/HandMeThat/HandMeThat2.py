...
from smach_special.HandMeThat_lib2 import *
...
Author: yishui
Date: 2022-11-25
LastEditTime: 2022-11-25 2:56:26
LastEditors: yishui
Description: Codes for 2022中国机器人大赛通用项目 修改版2
...
class HandMeThat():
    def __init__(self):
        ...
        self.xm_Receive_Task = StateMachine(
            outcomes=['succeeded', 'aborted', 'error'],
            input_keys=["people_pos", 'target',
                        'action', 'people_correct_pos', 'turn', 'people_name', 'name_pos_dict', 'pos_name_dict'],
        ...
        with self.xm_Receive_Task:
            ...
            StateMachine.add('SPEAK_OBJECT',
                             SpeakAnswer1(),
                             transitions={'succeeded': 'GET_PEOPLE_NAME',
        ...
        with self.xm_Give_Object:
            ...
            StateMachine.add('FIND_GUEST',
                             FindGuest(),
                             transitions={'succeeded': 'NAV_BACK_HALL',
                                          'aborted': 'FIND_GUEST', 'error': 'error'})
            ...
            StateMachine.add('CHECK_CURRENT_OBJECT_NUM',
                             ...
                             transitions={'succeeded': 'NAV', 'finish': 'succeeded', 'error': 'error'})
        ...
        with self.xm_HandMeTHat:
            ...
            StateMachine.add('FIND_ALL_PEOPLE',
                             FindAllPeople3(),  # 识别到三个人的位置，计算出全局位置并返回
                             transitions={'succeeded': 'RECEIVE_TASKS', 'aborted': 'FIND_ALL_PEOPLE', 'error': 'error'})
