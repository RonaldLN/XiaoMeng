...
class Receptionist():
    def __init__(self):
        ...
        with self.xm_Arm_OpenDoor:
            ...
            self.xm_Arm_OpenDoor.userdata.arm_waypoints = [[0,-1.4,3.14,0]]
            #self.xm_Arm_OpenDoor.userdata.arm_open_door_waypoints = [[-0.2,-0.7,0.5,0,0,1.4]]
            self.xm_Arm_OpenDoor.userdata.arm_open_door_waypoints = [[0,-1.4,3.14,0]]
        ...
        with self.xm_PointHost2:
            self.xm_PointHost2.userdata.arm_waypoints = [[0,-1.3,1.57,0]]
        ...
        with self.xm_PointHost1:
            self.xm_PointHost1.userdata.arm_waypoints = [[0,-1.3,1.57,0]]
        ...
        with self.xm_PointGuest:
            self.xm_PointGuest.userdata.arm_waypoints = [[0,-1.3,1.57,0]]
        ...
        with self.xm_PointSeat:
            self.xm_PointSeat.userdata.arm_waypoints = [[0,-1.3,1.57,0]]
        ...
        with self.RECEPTIONIST:
            ...
            StateMachine.add('ASK_LOOK',
                                Speak(),
                                transitions={'succeeded':'TAKE_A_PHOTO','aborted':'ASK_LOOK','error':'error'},
