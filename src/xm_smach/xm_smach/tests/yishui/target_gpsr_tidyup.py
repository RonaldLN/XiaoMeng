...
# 垃圾桶位置
'put_down': {'pos': Pose(Point(1.6328, 0.46815, 0), Quaternion(0, 0, 0.97512, -0.22167)), 'mode': 1 },
...
# 'bedroom_pos': {'pos': Pose(Point(2.3529, 0.96717, 0), Quaternion(0, 0, -0.63064, 0.77607)), 'mode': 1 },

# # 座位
# 'char1': {'pos': Pose(Point(2.3529, 0.96717, 0), Quaternion(0, 0, -0.63064, 0.77607)), 'mode': 1 },
# 'char2': {'pos': Pose(Point(2.3529, 0.96717, 0), Quaternion(0, 0, -0.63064, 0.77607)), 'mode': 1 },
