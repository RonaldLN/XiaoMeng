...
class HandMeThat():
    def __init__(self):
        ...
        with self.xm_HandMeTHat:
            ...
            self.xm_HandMeTHat.userdata.gettopoint3 = gpsr_target['gettopoint3']['pos']
            self.xm_HandMeTHat.userdata.gettopoint4 = gpsr_target['gettopoint4']['pos']
            self.xm_HandMeTHat.userdata.gettopoint5 = gpsr_target['gettopoint5']['pos']
            ...
            StateMachine.add('GO1',
                             NavStack(),
                             transitions={'succeeded': 'FACE_DETECT1', 'aborted': 'aborted', 'error': 'error'},
                             remapping={"pos_xm": 'gettopoint1'})
            # 检测是否有人
            StateMachine.add('FACE_DETECT1',
                             OpenDoorDetect(),
                             transitions={'succeeded': 'RECEIVE_TASKS', 'aborted': 'GO2', 'error': 'error'})
            #GO2
            StateMachine.add('GO2',
                             NavStack(),
                             transitions={'succeeded': 'FACE_DETECT2', 'aborted': 'aborted', 'error': 'error'},
                             remapping={"pos_xm": 'gettopoint2'})
            
            # 检测是否有人
            StateMachine.add('FACE_DETECT2',
                             OpenDoorDetect(),  
                             transitions={'succeeded': 'RECEIVE_TASKS', 'aborted': 'GO3', 'error': 'error'})
           
            #GO3
            StateMachine.add('GO3',
                             NavStack(),
                             transitions={'succeeded': 'FACE_DETECT3', 'aborted': 'aborted', 'error': 'error'},
                             remapping={"pos_xm": 'gettopoint3'})
            # 检测是否有人
            StateMachine.add('FACE_DETECT3',
                             OpenDoorDetect(),  
                             transitions={'succeeded': 'RECEIVE_TASKS', 'aborted': 'GO4', 'error': 'error'})

            #GO4
            StateMachine.add('GO4',
                             NavStack(),
                             transitions={'succeeded': 'FACE_DETECT4', 'aborted': 'aborted', 'error': 'error'},
                             remapping={"pos_xm": 'gettopoint4'})
            # 检测是否有人
            StateMachine.add('FACE_DETECT4',
                             OpenDoorDetect(),  
                             transitions={'succeeded': 'RECEIVE_TASKS', 'aborted': 'GO5', 'error': 'error'})
            #GO5
            StateMachine.add('GO5',
                             NavStack(),
                             transitions={'succeeded': 'FACE_DETECT5', 'aborted': 'aborted', 'error': 'error'},
                             remapping={"pos_xm": 'gettopoint5'})
            # 检测是否有人
            StateMachine.add('FACE_DETECT5',
                             OpenDoorDetect(),  
                             transitions={'succeeded': 'RECEIVE_TASKS', 'aborted': 'GO6', 'error': 'error'})
