...
{
class BaseVelocityHandle : public BaseStateHandle//控制底盘的速度
{
public:
...
class BaseVelocityInterface : public HardwareResourceManager<BaseVelocityHandle, ClaimResources> {};//第二个继承类一般默认为dontclaimresource，这里改变了 。这里继承的是一个ros官方的类，不是电子组那边的操作
}
//多了三个cmd数据
