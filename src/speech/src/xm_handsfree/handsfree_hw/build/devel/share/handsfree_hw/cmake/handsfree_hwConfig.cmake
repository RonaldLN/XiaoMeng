...
if("TRUE" STREQUAL "TRUE")
  set(handsfree_hw_SOURCE_PREFIX /home/rainney/catkin_ws/src/handsfree_hw)
  set(handsfree_hw_DEVEL_PREFIX /home/rainney/catkin_ws/src/handsfree_hw/build/devel)
...
if(NOT "/home/rainney/catkin_ws/src/handsfree_hw/include " STREQUAL " ")
  set(handsfree_hw_INCLUDE_DIRS "")
  set(_include_dirs "/home/rainney/catkin_ws/src/handsfree_hw/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handsfree_hw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rainney/catkin_ws/src/handsfree_hw/${idir}'.  ${_report}")
    endif()
    _list_append_unique(handsfree_hw_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "handsfree_hw")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rainney/catkin_ws/src/handsfree_hw/build/devel/lib;/home/rainney/carto_ws/install_isolated/lib;/home/rainney/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "controller_manager;geometry_msgs;hardware_interface;realtime_tools;roscpp;std_msgs;xm_msgs")
