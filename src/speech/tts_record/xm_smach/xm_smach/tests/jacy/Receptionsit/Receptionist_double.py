...
LastEditTime: 2020-11-14 07:27:57
...
class Receptionist():
    def __init__(self):
        ...
        with self.sm_Arm_OpenDoor:
            self.sm_Arm_OpenDoor.userdata.sentence_open_door = 'i will open the door ,please be attention'
        ...
        with self.RECEPTIONIST:
            ...
            self.RECEPTIONIST.userdata.sentences_ask = 'tell me your name and what you like.'
            ...
            StateMachine.add('SPEAK_FOLLOW1',
                                Speak(),
                                transitions={'succeeded':'NAVLIVINGROOM1','aborted':'aborted','error':'error'},
                                remapping ={'sentences':'sentences_follow'}
                                ) 
            StateMachine.add('NAVLIVINGROOM1',
                                NavStack(),
                                transitions={'succeeded':'SPEAK_RIGHT_POSE1','aborted':'SPEAK_RIGHT_POSE1','error':'error'},
                                remapping ={'pos_xm':'pos_scan'}
                                )
            StateMachine.add('SPEAK_RIGHT_POSE1',
                                Speak(),
                                transitions={'succeeded':'WAIT_STAND_RIGHT1','aborted':'aborted','error':'error'},
            ...
            StateMachine.add('RECEPTIONIST1',
                                Speak(),
                                transitions={'succeeded':'POINTSEAT1','aborted':'aborted','error':'error'},
            ...
            StateMachine.add('RECEPTIONIST2',
                                Speak(),
                                transitions={'succeeded':'POINTSEAT2','aborted':'aborted','error':'error'},
                                remapping ={'sentences':'receptionist_sentence'}
                                ) 
