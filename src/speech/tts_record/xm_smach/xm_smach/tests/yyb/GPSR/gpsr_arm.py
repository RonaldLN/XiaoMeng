...
class Gpsr():
    def __init__(self):
        ...
        with self.xm_GPSR:
            ...
            self.xm_GPSR.userdata.turn = 3              #the max_num of the mission
            ...
            self.xm_GPSR.userdata.target.append('cola')
            ...
            StateMachine.add('BACK_DOOR',
                                NavStack(),
                                transitions = {'succeeded':'succeeded','aborted':'BACK_DOOR','error':'error'},
            ...
            StateMachine.add('PICK_UP',
                                self.xm_Pick_up,
                                remapping ={'target':'target','current_task':'current_task'},
                                transitions={'succeeded':'BACK_DOOR','aborted':'PICK_UP'})
