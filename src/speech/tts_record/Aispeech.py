...
API_KEY = 'VkhwszE42AXXt18VKMkK4T82'
SECRET_KEY = 'NMbWRAtERGNqnOE7hFOmRMxgiaRU83Zp'

TEXT = "ninety-nine thousands nine hundreds and ninety-nine"
...
if __name__ == '__main__':
    ...
    save_file = "error.txt" if has_error else 'gpsr_questions/99999.' + FORMAT
